...
description: 输入目标站点、竞品 ASIN 和真实产品资料，生成多语言 Amazon Listing 与主附图/A+策划；支持单品及父子体，交付 Markdown、JSON 和完整 HTML 报告，完整输出父子标题与单条 Item Highlight，并按外观差异规划共用和逐子体图片方案。
---
...
1. 锁定完整产品核心名称、真实参数与子体清单，再分配关键词和购买意图。
