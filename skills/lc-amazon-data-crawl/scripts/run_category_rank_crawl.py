#!/usr/bin/env python3
"""
Local launcher for the Amazon category ranking crawler.

Usage:
  python scripts/run_category_rank_crawl.py
  python scripts/run_category_rank_crawl.py --config config/category_rank_crawler.json --dry-run
"""
...
CRAWLER = ROOT_DIR / "scripts" / "amazon_category_rank_crawler.py"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the Amazon category ranking crawler from a local config file.")
